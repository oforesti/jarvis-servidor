-- Esquema do servidor de licencas, versao Postgres.
--
-- Gerado a partir de esquema.sql, com as duas unicas diferencas que existem:
-- o id que se gera sozinho (SERIAL no lugar de AUTOINCREMENT) e o inteiro
-- que guarda verdadeiro ou falso. As colunas de data continuam TEXT, em ISO
-- e UTC, iguais nos dois bancos - assim nenhuma consulta do codigo muda.
